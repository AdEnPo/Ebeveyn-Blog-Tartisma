...
<div class="container" >
 ...
 <hr/>
     <h3>Popular last time! <--> Öne Çıkanlar</h3>
        <hr/>
        <!-- Main Card -->
        <script src="build/squire-raw.js"></script>
        <iframe src="build/document.html">
            ...
            <div class="col-md-5 " style=" ">
                <div class="row ozel-scrollbar shadow" id="scrollDiv" style="padding:0px; height:466px; position:relative;  text-align: justify; overflow-y: scroll; background-color: #ECF0F1; background-color: #ECF0F1;  color:#2E4053; line-height: 1.6em">
                    ...
                    <div class="list-group " style="">
                        ...
                        <a href="#" class=" list-group-item list-group-item-action flex-column align-items-start active" style=" ">
                            <div class="d-flex w-100 justify-content-between">
                                <h5 class="mb-1">List group item heading</h5>
        ...
        <div class="row">
            <div class="col-md-12">
                <h4 class="ml-3">-> Son Yazılar</h4>
                <hr class="mt-1">
            </div>
        </div>
		    <div class="row" style="padding-left:15px;">
            <div class="col-md-6 col-lg-6 " style="">
            <div class="row ozel-scrollbar shadow ulList" id="scrollDiv" style="padding:0px; margin-right:-5px; height:466px; position:relative;  text-align: justify; overflow-y: scroll; background-color: #ECF0F1; background-color: #ECF0F1;  color:#2E4053; line-height: 1.6em">
            ...
            <div class="col-md-6 " style="">
                <div class="row ozel-scrollbar shadow ulList" id="scrollDiv" style="padding:0px; height:466px; position:relative;  text-align: justify; overflow-y: scroll; background-color: #ECF0F1; background-color: #ECF0F1;  color:#2E4053; line-height: 1.6em">


                    <div class="list-group " style="">
                        <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
                            <div class="d-flex w-100 justify-content-between">
                                <h5 class="mb-1">Lisaat group item heading</h5>
                                <small class="text-muted">3 days ago</small>
                            </div>
                            <p class="mb-1">Donec id elit non mi porta gravida at eget metus. Maecenas sed diam eget risus varius blandit.</p>
                            <small class="text-muted">Donec id elit non mi porta.</small>
